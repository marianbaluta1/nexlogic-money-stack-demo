      ...
      <nav className="space-y-2">
        {sidebarItems.map((item) => (
          <button
            key={item.label}
            type="button"
            className="w-full rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-3 text-left text-white/70 transition hover:border-white/15 hover:bg-white/[0.06] hover:text-white"
          >
